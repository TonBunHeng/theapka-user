...
export const Button = forwardRef(
  (
    ...
    const baseStyles =
      'inline-flex items-center justify-center font-medium font-ui rounded-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed select-none touch-target'
